...
public class Pokemon {
	...
	public Pokemon(int id, String num, String name, String img, List<Object> type, String height, String weight, String candy,
			int candy_count, String egg, double spawn_chance, int avg_spawns, String spawn_time, List<Object> multipliers,
			List<Object> weaknesses, List<Object> next_evolution) {
		super();
		this.id = id;
		this.num = num;
		this.name = name;
