...
public class Pokemon4 {
	...
	private List<Object> next_evolution;
	
	public Pokemon4(int id, String num, String name, String img, List<Object> type, String height, String weight,
			String candy, int candy_count, String egg, double spawn_chance, double avg_spawns, String spawn_time,
			List<Object> multipliers, List<Object> weaknesses, List<Object> next_evolution) {
		super();
		this.id = id;
		this.num = num;
		this.name = name;
	...
	public List<Object> getNext_evolution() {
		return next_evolution;
	}
	
	public void setNext_evolution(List<Object> next_evolution) {
		this.next_evolution = next_evolution;
	}
